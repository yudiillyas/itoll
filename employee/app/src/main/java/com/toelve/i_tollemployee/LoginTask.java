...
public class LoginTask extends AsyncTask<String,Void,String> {
   ...
   private  AlertDialog alertDialog;
    ...
    protected String doInBackground(String... params) {
        String login_url = "http://toelve.com/itoll/mobile/user/login";
        String method = params[0];
        if (method.equalsIgnoreCase("login")) {
            username = params[1];
            String password = params[2];
            String token = params[3];
            String unik_id = params[4];
            ...
            try {
                ...
                String data = URLEncoder.encode("username", "UTF-8") + "=" + URLEncoder.encode(username, "UTF-8") + "&" +
                        ...
                        URLEncoder.encode("unik_id", "UTF-8") + "=" + URLEncoder.encode(unik_id, "UTF-8");
    ...
    protected void onPostExecute(String result) {
        try {
            ...
            if(result.contains("datauser")){
                boyprefs.edit().putString("datauser",result)
